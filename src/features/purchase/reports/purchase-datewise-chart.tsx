...
const PurchaseDatewiseChart: React.FC<{ title: string; data: any }> = (props: { title: string; data: any }): any => {
...
export default PurchaseDatewiseChart;